...
namespace WhiteLagoon.Application.Services.Implementation
{
    public class VillaService : IVillaService
    {
        ...
        private readonly string _webRoothPath;

        public VillaService(IUnitOfWork unitOfWork,string webroothPath)
        {
            _unitOfWork = unitOfWork;
            _webRoothPath = webroothPath;
        }
        ...
        public void CreateVilla(Villa villa)
        {
            if (villa.Image != null)
            {
                ...
                string imagePath = Path.Combine(_webRoothPath, @"images\VillaImage");
        ...
        public bool DeleteVilla(int id)
        {
            try
            {
                ...
                if (objFromDb is not null)
                {
                    ...
                    {
                        var oldImagePath = Path.Combine(_webRoothPath, objFromDb.ImageUrl.TrimStart('\\'));
        ...
        public void UpdateVilla(Villa villa)
        {
            if (villa.Image != null)
            {
                ...
                {
                    var oldImagePath = Path.Combine(_webRoothPath, villa.ImageUrl.TrimStart('\\'));
